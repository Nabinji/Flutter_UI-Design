...
class MyCoffeeDetailPage extends StatefulWidget {
  const MyCoffeeDetailPage({super.key, required this.coffee});
  final Coffee coffee;

  @override
  State<MyCoffeeDetailPage> createState() => _MyCoffeeDetailPageState();
}

class _MyCoffeeDetailPageState extends State<MyCoffeeDetailPage> {
